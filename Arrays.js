...
// console.log(arr2.includes(3))// true The includes() method of Array instances determines whether an array includes a certain value among its entries, returning true or false as appropriate.
...
// myHeros.push(fruints) // Array fruits to be added inside the myHeros array as a array element.
// console.log(myHeros)
...
const mySpreadArr = [...myHeros, ...fruits] // this is spread operator method in arrays to join or merge two arrays 
...
// const myNewArray = "Faisal"
// console.log(Array.isArray(myNewArray)) //false
// console.log(Array.from("Faisal")); //[ 'F', 'a', 'i', 's', 'a', 'l' ]
